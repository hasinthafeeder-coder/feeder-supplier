    ...
    <div class="sidebar-area" id="sidebar-area">
        <div class="logo position-relative d-flex align-items-center justify-content-between">
            ...
            <button
                ...
                <span class="border-1 d-block for-dark-burger" style="
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu active" data-simplebar>
            <ul class="menu-inner">
                ...
                <li class="menu-item open">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="index.html" class="menu-link active"> E-Commerce </a>
                        </li>
                        <li class="menu-item">
                            <a href="crm.html" class="menu-link"> CRM </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="lms.html" class="menu-link"> LMS </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="school.html" class="menu-link"> School </a>
                        </li>
                        <li class="menu-item">
                            <a href="marketing.html" class="menu-link"> Marketing </a>
                        </li>
                        <li class="menu-item">
                            <a href="analytics.html" class="menu-link"> Analytics </a>
                        </li>
                        <li class="menu-item">
                            <a href="hospital.html" class="menu-link"> Hospital </a>
                        </li>
                        <li class="menu-item">
                            <a href="finance.html" class="menu-link"> Finance </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="inbox.html" class="menu-link"> Inbox </a>
                        </li>
                        <li class="menu-item">
                            <a href="compose.html" class="menu-link"> Compose </a>
                        </li>
                        <li class="menu-item">
                            <a href="read-email.html" class="menu-link"> Read </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="my-drive.html" class="menu-link"> My Drive </a>
                        </li>
                        <li class="menu-item">
                            <a href="assets.html" class="menu-link"> Assets </a>
                        </li>
                        <li class="menu-item">
                            <a href="projects-file.html" class="menu-link"> Projects </a>
                        </li>
                        <li class="menu-item">
                            <a href="personal.html" class="menu-link"> Personal </a>
                        </li>
                        <li class="menu-item">
                            <a href="applications.html" class="menu-link"> Applications </a>
                        </li>
                        <li class="menu-item">
                            <a href="documents.html" class="menu-link"> Documents </a>
                        </li>
                        <li class="menu-item">
                            <a href="media.html" class="menu-link"> Media </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            <a href="edit-product.html" class="menu-link"> Edit Product </a>
                        </li>
                        <li class="menu-item">
                            <a href="cart.html" class="menu-link"> Cart </a>
                        </li>
                        <li class="menu-item">
                            <a href="checkout.html" class="menu-link"> Checkout </a>
                        </li>
                        <li class="menu-item">
                            <a href="orders.html" class="menu-link"> Orders </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="create-order.html" class="menu-link"> Create Order </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="customers.html" class="menu-link"> Customers </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="categories.html" class="menu-link"> Categories </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="sellers.html" class="menu-link"> Sellers </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="reviews.html" class="menu-link"> Reviews </a>
                        </li>
                        <li class="menu-item">
                            <a href="refunds.html" class="menu-link"> Refunds </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="contacts-crm.html" class="menu-link"> Contacts </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="customers-crm.html" class="menu-link"> Customers </a>
                        </li>
                        <li class="menu-item">
                            <a href="leads.html" class="menu-link"> Leads </a>
                        </li>
                        <li class="menu-item">
                            <a href="create-lead.html" class="menu-link"> Create Lead </a>
                        </li>
                        <li class="menu-item">
                            <a href="deals.html" class="menu-link"> Deals </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            <a href="clients.html" class="menu-link"> Clients </a>
                        </li>
                        <li class="menu-item">
                            <a href="teams.html" class="menu-link"> Teams </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="users.html" class="menu-link"> Users </a>
                        </li>
                        <li class="menu-item">
                            <a href="create-user.html" class="menu-link"> Create User </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="courses-list.html" class="menu-link"> Courses List </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="edit-course.html" class="menu-link"> Edit Course </a>
                        </li>
                        <li class="menu-item">
                            <a href="instructors.html" class="menu-link"> Instructors </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="tickets.html" class="menu-link"> Tickets </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="agents.html" class="menu-link"> Agents </a>
                        </li>
                        <li class="menu-item">
                            <a href="reports.html" class="menu-link"> Reports </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            <a href="add-leave.html" class="menu-link"> Add Leave </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="departments.html" class="menu-link"> Departments </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="holidays.html" class="menu-link"> Holidays </a>
                        </li>
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="student-list.html" class="menu-link"> Student List </a>
                        </li>
                        <li class="menu-item">
                            <a href="add-student.html" class="menu-link"> Add Student </a>
                        </li>
                        <li class="menu-item">
                            <a href="teacher-list.html" class="menu-link"> Teacher List </a>
                        </li>
                        <li class="menu-item">
                            <a href="add-teacher.html" class="menu-link"> Add Teacher </a>
                        </li>
                        <li class="menu-item">
                            <a href="staff-list.html" class="menu-link"> Staff List </a>
                        </li>
                        <li class="menu-item">
                            <a href="add-staff.html" class="menu-link"> Add Staff </a>
                        </li>
                        <li class="menu-item">
                            <a href="all-courses.html" class="menu-link"> All Courses </a>
                        </li>
                        <li class="menu-item">
                            <a href="add-course.html" class="menu-link"> Add Course </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="add-fees.html" class="menu-link"> Add Fees </a>
                        </li>
                        <li class="menu-item">
                            <a href="school-attendance.html" class="menu-link">
                                Attendance
                        ...
                        <li class="menu-item">
                            <a href="library.html" class="menu-link"> Library </a>
                        </li>
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="patients.html" class="menu-link"> Patients </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="doctors.html" class="menu-link"> Doctors </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="all-schedule.html" class="menu-link"> All Schedule </a>
                        </li>
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="invoices.html" class="menu-link"> Invoices </a>
                        </li>
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="team-members.html" class="menu-link"> Team Members </a>
                        </li>
                        <li class="menu-item">
                            <a href="users-list.html" class="menu-link"> Users List </a>
                        </li>
                        <li class="menu-item">
                            <a href="add-user.html" class="menu-link"> Add User </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="user-profile.html" class="menu-link"> User Profile </a>
                        </li>
                        <li class="menu-item">
                            <a href="teams2.html" class="menu-link"> Teams </a>
                        </li>
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            <a href="remix-icon.html" class="menu-link"> RemixIcon </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="alerts.html" class="menu-link"> Alerts </a>
                        </li>
                        <li class="menu-item">
                            <a href="avatar.html" class="menu-link"> Avatar </a>
                        </li>
                        <li class="menu-item">
                            <a href="buttons.html" class="menu-link"> Buttons </a>
                        </li>
                        <li class="menu-item">
                            <a href="cards.html" class="menu-link"> Cards </a>
                        </li>
                        <li class="menu-item">
                            <a href="carousels.html" class="menu-link"> Carousels </a>
                        </li>
                        <li class="menu-item">
                            <a href="dropdowns.html" class="menu-link"> Dropdowns </a>
                        </li>
                        <li class="menu-item">
                            <a href="grids.html" class="menu-link"> Grids </a>
                        </li>
                        <li class="menu-item">
                            <a href="images.html" class="menu-link"> Images </a>
                        </li>
                        <li class="menu-item">
                            <a href="list.html" class="menu-link"> List </a>
                        </li>
                        <li class="menu-item">
                            <a href="modals.html" class="menu-link"> Modals </a>
                        </li>
                        <li class="menu-item">
                            <a href="navs.html" class="menu-link"> Navs </a>
                        </li>
                        <li class="menu-item">
                            <a href="paginations.html" class="menu-link"> Pagination's </a>
                        </li>
                        <li class="menu-item">
                            <a href="progress.html" class="menu-link"> Progress </a>
                        </li>
                        <li class="menu-item">
                            <a href="spinners.html" class="menu-link"> Spinners </a>
                        </li>
                        <li class="menu-item">
                            <a href="tabs.html" class="menu-link"> Tabs </a>
                        </li>
                        <li class="menu-item">
                            <a href="accordions.html" class="menu-link"> Accordions </a>
                        </li>
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="basic-table.html" class="menu-link"> Basic Table </a>
                        </li>
                        <li class="menu-item">
                            <a href="data-table.html" class="menu-link"> Data Table </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            <a href="validation.html" class="menu-link"> Validation </a>
                        </li>
                        <li class="menu-item">
                            <a href="wizard.html" class="menu-link"> Wizard </a>
                        </li>
                        <li class="menu-item">
                            <a href="editors.html" class="menu-link"> Editors </a>
                        </li>
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="line.html" class="menu-link"> Line </a>
                        </li>
                        <li class="menu-item">
                            <a href="area.html" class="menu-link"> Area </a>
                        </li>
                        <li class="menu-item">
                            <a href="column.html" class="menu-link"> Column </a>
                        </li>
                        <li class="menu-item">
                            <a href="mixed.html" class="menu-link"> Mixed </a>
                        </li>
                        <li class="menu-item">
                            <a href="radial-bar.html" class="menu-link"> RadialBar </a>
                        </li>
                        <li class="menu-item">
                            <a href="radar.html" class="menu-link"> Radar </a>
                        </li>
                        <li class="menu-item">
                            <a href="pie.html" class="menu-link"> Pie </a>
                        </li>
                        <li class="menu-item">
                            <a href="polar.html" class="menu-link"> Polar </a>
                        </li>
                        <li class="menu-item">
                            <a href="more.html" class="menu-link"> More </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="sign-in.html" class="menu-link"> Sign In </a>
                        </li>
                        <li class="menu-item">
                            <a href="sign-up.html" class="menu-link"> Sign Up </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="lock-screen.html" class="menu-link"> Lock Screen </a>
                        </li>
                        <li class="menu-item">
                            <a href="logout.html" class="menu-link"> Logout </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            <a href="timeline.html" class="menu-link"> Timeline </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="coming-soon.html" class="menu-link"> Coming Soon </a>
                        </li>
                        <li class="menu-item">
                            <a href="blank-page.html" class="menu-link"> Blank Page </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            <a href="connections.html" class="menu-link"> Connections </a>
                        </li>
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item after-sub-menu menu-level">
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item">
                                    <a href="#" class="menu-link"> Level Three </a>
                                </li>
                            </ul>
                        </li>
                    </ul>
...
<main>
    ...
    <button class="btn btn-primary theme-settings-btn p-0 position-fixed z-2 text-center rounded-circle" style="
        bottom: 24px;
        right: 24px;
        width: 56px;
        height: 56px;
