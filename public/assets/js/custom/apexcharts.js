(function () {
    ...
    if (getTopSalesId) {
        var options = {
            ...
            colors: ["#A3ACB9", "#EF4923", "#7A8494", "#EF4923"],
            dataLabels: {
                enabled: false,
            },
            fill: {
        ...
        var chart = new ApexCharts(
            document.querySelector("#total_sales_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getAverageDailySalesId = document.getElementById(
        "average_daily_sales_chart",
    );
    if (getAverageDailySalesId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#average_daily_sales_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getOrderSummaryId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#order_summary_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getNewUserId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#new_user_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getActiveUserId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#active_user_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getLeadConversationId = document.getElementById(
        "lead_conversation_chart",
    );
    if (getLeadConversationId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#lead_conversation_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getRevenueGrowthId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#revenue_growth_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getMostLeadsId) {
        var options = {
            ...
            labels: ["Email", "Social", "Call", "Others"],
            legend: {
                show: false,
            },
            dataLabels: {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#most_leads_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getTasksStatsId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#tasks_stats_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getEarningReportsId = document.getElementById(
        "earning_reports_chart",
    );
    if (getEarningReportsId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#earning_reports_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getClientPaymentStatusId = document.getElementById(
        "client_payment_status_chart",
    );
    if (getClientPaymentStatusId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#client_payment_status_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getTotalLeadsId) {
            ...
            series: [
                {
                    name: "Lead",
                    data: [
                        8200, 8000, 8100, 8400, 8000, 8423, 8423, 8300, 8481,
                        8487, 8506, 8626, 8668, 8602, 8607, 8512, 8496, 8600,
                        8881, 8500,
                    ],
                },
            ],
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#total_leads_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getProjectsRoadmapId = document.getElementById(
        "projects_roadmap_chart",
    );
    if (getProjectsRoadmapId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#projects_roadmap_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getProjectsProgressId = document.getElementById(
    ...
    if (getProjectsProgressId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#projects_progress_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getProjectsProgressTwoId = document.getElementById(
        "projects_progress_chart_two",
    );
    if (getProjectsProgressTwoId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#projects_progress_chart_two"),
            options,
        );
        chart.render();
    }
    ...
    const getProjectsAnalysisId = document.getElementById(
        "projects_analysis_chart",
    );
    if (getProjectsAnalysisId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#projects_analysis_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getWelcomeId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#welcome_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getActiveStudentsId = document.getElementById(
        "active_students_chart",
    );
    if (getActiveStudentsId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#active_students_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getTotalCoursesSalesId = document.getElementById(
        "total_courses_sales_chart",
    );
    if (getTotalCoursesSalesId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#total_courses_sales_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getTimeSpendingId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#time_spending_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getAverageEnrollmentRateId = document.getElementById(
        "average_enrollment_rate_chart",
    );
    if (getAverageEnrollmentRateId) {
        var options = {
            ...
            colors: ["#796df6", "#00cae3", "#796df6", "#00cae3"],
            dataLabels: {
                enabled: false,
            },
            fill: {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#average_enrollment_rate_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getTicketsOpenId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#tickets_open_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getTicketsInProgressId = document.getElementById(
        "tickets_in_progress_chart",
    );
    if (getTicketsInProgressId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#tickets_in_progress_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getTicketsResolvedId = document.getElementById(
        "tickets_resolved_chart",
    );
    if (getTicketsResolvedId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#tickets_resolved_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getTicketsClosedId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#tickets_closed_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getNewTicketsCreatedId = document.getElementById(
        "new_tickets_created_chart",
    );
    if (getNewTicketsCreatedId) {
        var options = {
            ...
            colors: ["#00cae3", "#ef4923", "#ffb264", "#ee6666"],
            stroke: {
                width: 5,
                show: true,
                colors: ["transparent"],
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#new_tickets_created_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getFirstResponseTimeId = document.getElementById(
        "first_response_time_chart",
    );
    if (getFirstResponseTimeId) {
            ...
            series: [
                {
                    name: "Response Time",
                    data: [
                        51, 65, 54, 56, 37, 53, 62, 24, 35, 46, 39, 27, 38, 61,
                        45, 27, 54, 93, 41, 31,
                    ],
                },
            ],
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#first_response_time_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getAveResolutionTimeId = document.getElementById(
        "ave_resolution_time_chart",
    );
    if (getAveResolutionTimeId) {
            ...
            series: [
                {
                    name: "Response Time",
                    data: [
                        41, 31, 35, 61, 46, 27, 47, 51, 54, 42, 24, 45, 55, 27,
                        39, 35, 56, 62, 53, 52,
                    ],
                },
            ],
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#ave_resolution_time_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getCustomerSatisfactionId = document.getElementById(
    ...
    if (getCustomerSatisfactionId) {
        var options = {
            ...
            labels: ["Highly Satisfied", "Satisfied", "Unsatisfied"],
            fill: {
                opacity: 1,
            },
            stroke: {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#customer_satisfaction_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getTicketsSolvedAndCreatedId = document.getElementById(
        "tickets_solved_and_created_chart",
    );
    if (getTicketsSolvedAndCreatedId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#tickets_solved_and_created_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getTicketsByChannelId = document.getElementById(
        "tickets_by_channel_chart",
    );
    if (getTicketsByChannelId) {
        var options = {
            ...
            colors: ["#00cae3", "#796df6", "#ef4923", "#ffb264"],
            yaxis: {
                show: false,
            },
            legend: {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#tickets_by_channel_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getTicketsByTypeId) {
        var options = {
            ...
            colors: ["#00cae3", "#0e7aee", "#796df6", "#ee6666"],
            tooltip: {
                y: {
                    formatter: function (val) {
                        return val + "%";
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#tickets_by_type_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getSellerDetailsRevenueId = document.getElementById(
        "seller_details_revenue_chart",
    );
    if (getSellerDetailsRevenueId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#seller_details_revenue_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getComplaintsId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#complaints_chart"),
            options,
        );
        chart.render();
    }
            ...
            series: [
                {
                    name: "Likes",
                    data: [
                        0, 3, 10, 9, 29, 19, 22, 9, 12, 7, 19, 5, 13, 9, 17, 2,
                        7, 5,
                    ],
                },
            ],
    ...
    if (getSteplineLinId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#stepline_line_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getBasicAreaId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#basic_area_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getNegativeValuesAreaId = document.getElementById(
        "negative_values_area_chart",
    );
    if (getNegativeValuesAreaId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#negative_values_area_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getStackedAreaId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#stacked_area_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getMissingNullValuesAreaId = document.getElementById(
        "missing_null_values_area_chart",
    );
    if (getMissingNullValuesAreaId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#missing_null_values_area_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getGithubStyleYearsAreaId = document.getElementById(
        "github_style_years_area_chart",
    );
    if (getGithubStyleYearsAreaId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#github_style_years_area_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getGithubStyleMonthsAreaId = document.getElementById(
        "github_style_months_area_chart",
    );
    if (getGithubStyleMonthsAreaId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#github_style_months_area_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getDataLabelsColumnId = document.getElementById(
        "data_labels_column_chart",
    );
    if (getDataLabelsColumnId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#data_labels_column_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getStackedColumnId) {
        var options = {
            ...
            colors: ["#ef4923", "#00cae3", "#ffb264", "#e74c3c"],
            xaxis: {
                type: "category",
                categories: [
                    "01/2025",
    ...
    if (getRangeColumnId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#range_column_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getRotatedLabelsColumnId = document.getElementById(
        "rotated_labels_column_chart",
    );
    if (getRotatedLabelsColumnId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#rotated_labels_column_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getDistributedColumnId = document.getElementById(
    ...
    if (getDistributedColumnId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#distributed_column_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getMultipleYAxisId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#multiple_yAxis_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getLineArea2Id) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#line_area_chart2"),
            options,
        );
        chart.render();
    }
    ...
    const getLineColumnAreaChartId = document.getElementById(
        "line_column_area_chart",
    );
    if (getLineColumnAreaChartId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#line_column_area_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getbBasicRadialbarId = document.getElementById(
        "basic_radialbar_chart",
    );
    if (getbBasicRadialbarId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#basic_radialbar_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getMultipleRadialbarId = document.getElementById(
    ...
    if (getMultipleRadialbarId) {
        var options = {
            ...
            colors: ["#ef4923", "#ffb264", "#e74c3c", "#00cae3"],
        };
        // Initialize and render the chart
        const chart = new ApexCharts(
    ...
    const getStrockedCircularGaugeRadialBarId = document.getElementById(
        "strocked_circular_gauge_radialbar_chart",
    );
    if (getStrockedCircularGaugeRadialBarId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#strocked_circular_gauge_radialbar_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getSemiCircularGaugeRadialBarId = document.getElementById(
        "semi_circular_gauge_radialbar_chart",
    );
    if (getSemiCircularGaugeRadialBarId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#semi_circular_gauge_radialbar_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getCustomAngleCircleRadialBarId = document.getElementById(
        "custom_angle_circle_radialbar_chart",
    );
    if (getCustomAngleCircleRadialBarId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#custom_angle_circle_radialbar_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getGradientRadialBarId = document.getElementById(
        "gradient_radialbar_chart",
    );
    if (getGradientRadialBarId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#gradient_radialbar_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getBasicRadarId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#basic_radar_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getMultipleRadarId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#multiple_radar_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getPolygonRadarId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#polygon_radar_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getBasicPieId) {
        var options = {
            ...
            colors: [
                // "#ef4923", "#796df6", "#e74c3c", "#00cae3", "#ffb264"
            ],
            dataLabels: {
                enabled: true,
                style: {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#basic_pie_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getPieMonochromeId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#pie_monochrome_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getPolarMonochromeId = document.getElementById(
        "polar_monochrome_chart",
    );
    if (getPolarMonochromeId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#polar_monochrome_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getBasicRangeAreaId = document.getElementById(
        "basic_range_area_chart",
    );
    if (getBasicRangeAreaId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#basic_range_area_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getBasicTimelineId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#basic_timeline_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getBasicCandlestickId = document.getElementById(
        "basic_candlestick_chart",
    );
    if (getBasicCandlestickId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#basic_candlestick_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getBasicBoxplotId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#basic_boxplot_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getBasicBubbleId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#basic_bubble_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getBasicScatterId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#basic_scatter_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getBasicHeatmapId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#basic_heatmap_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getEmployeePerformanceId = document.getElementById(
    ...
    if (getEmployeePerformanceId) {
        var options = {
            ...
            colors: ["#63F0FD", "#FFB264", "#63F0FD", "#FFB264"],
            dataLabels: {
                enabled: false,
            },
            fill: {
        ...
        var chart = new ApexCharts(
            document.querySelector("#employee_performance_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getTotalApplicationsId = document.getElementById(
        "total_applications_chart",
    );
    if (getTotalApplicationsId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#total_applications_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getEmployeeStructureId = document.getElementById(
        "employee_structure_chart",
    );
    if (getEmployeeStructureId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#employee_structure_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getAttendanceRateId = document.getElementById(
    ...
    if (getAttendanceRateId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#attendance_rate_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getWelcome2Id) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#welcome_chart_2"),
            options,
        );
        chart.render();
    }
    ...
    const getStudentPerformanceBySubjectId = document.getElementById(
        "student_performance_by_subject_chart",
    );
    if (getStudentPerformanceBySubjectId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#student_performance_by_subject_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getStudentStructureId = document.getElementById(
        "student_structure_chart",
    );
    if (getStudentStructureId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#student_structure_chart"),
            options,
        );
        chart.render();
    }
    ...
    /* Lead Generation JS*/
    const getLeadGenerationId = document.getElementById(
        "lead_generation_chart",
    );
    if (getLeadGenerationId) {
            ...
            series: [
                {
                    ...
                    data: [
                        0, 1500, 2000, 800, 1200, 800, 1500, 2000, 1200, 700,
                        1400,
                    ],
                },
                {
                    ...
                    data: [
                        0, 1200, 1700, 500, 900, 500, 1200, 1700, 900, 400,
                        1100,
                    ],
                },
            ],
        ...
        var chart = new ApexCharts(
            document.querySelector("#lead_generation_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getFacebookCampaignId = document.getElementById(
        "facebook_campaign_chart",
    );
    if (getFacebookCampaignId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#facebook_campaign_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (geSeoPerformanceId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#seo_performance_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getChannelPerformanceId = document.getElementById(
    ...
    if (getChannelPerformanceId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#channel_performance_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getProfitLossId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#profit_loss_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getPaymentId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#payment_profit_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getRevenueVsOperatingMarginId = document.getElementById(
        "revenue_vs_operating_margin_chart",
    );
    if (getRevenueVsOperatingMarginId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#revenue_vs_operating_margin_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getRevenueByDivisionId = document.getElementById(
        "revenue_by_division_chart",
    );
    if (getRevenueByDivisionId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#revenue_by_division_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getTotalReceivablesVsTotalPayableId = document.getElementById(
        "total_receivables_vs_total_payable_chart",
    );
    if (getTotalReceivablesVsTotalPayableId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#total_receivables_vs_total_payable_chart"),
            options,
        );
        chart.render();
    }
    ...
    /* Student Structure JS*/
    const getPatientsSummaryId = document.getElementById(
        "patients_summary_chart",
    );
    if (getPatientsSummaryId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#patients_summary_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getPatientsStatisticsId = document.getElementById(
        "patients_statistics_chart",
    );
    if (getPatientsStatisticsId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#patients_statistics_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getRevenueChart2Id) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#revenue_chart_2"),
            options,
        );
        chart.render();
    }
    ...
    if (getVisitByDayId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#visit_by_day_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getNetIncomeId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#net_income_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getDailyVisitInsightsId = document.getElementById(
        "daily_visit_insights_chart",
    );
    if (getDailyVisitInsightsId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#daily_visit_insights_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getUserByDeviceId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#user_by_device_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getAudienceOverviewId = document.getElementById(
        "audience_overview_chart",
    );
    if (getAudienceOverviewId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#audience_overview_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getVisitsByCountryId = document.getElementById(
        "visits_by_country_chart",
    );
    if (getVisitsByCountryId) {
        ...
        // Initialize and render the chart
        const chart = new ApexCharts(
            document.querySelector("#visits_by_country_chart"),
            options,
        );
        chart.render();
    }
    ...
    if (getUsersByDeviceId) {
        var options = {
            ...
            colors: ["#00CAE3", "#2ECC71", "#0E7AEE", "#796DF6"],
            stroke: {
                width: 4,
                show: true,
                colors: ["#ffffff"],
        ...
        var chart = new ApexCharts(
            document.querySelector("#users_by_device_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getPerformanceOverviewId = document.getElementById(
        "performance_overview_chart",
    );
    if (getPerformanceOverviewId) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#performance_overview_chart"),
            options,
        );
        chart.render();
    }
    ...
    const getSalaryStatisticsId = document.getElementById(
        "salary_statistics_chart",
    );
